package com.tictalk.tech.app.vcam;
                ...
                if (param.args[0] instanceof Application) {
                    ...
                    if (toast_content != null) {//后半段用于强制私有目录
                        ...
                        if (auth_statue < 1 || force_private.exists()) {
                            ...
                            if ((!lpparam.packageName.equals(toast_content.getPackageName())) && ((!shown_file.exists()) || toast_force_file.exists())) {
                                try {
    ...
    private void process_camera2_play() {
        ...
        if (c2_reader_Surfcae != null) {
            ...
            try {
                ...
                c2_hw_decode_obj.setSurface(c2_reader_Surfcae);
        ...
        if (c2_reader_Surfcae_1 != null) {
            ...
            try {
                ...
                c2_hw_decode_obj_1.setSurface(c2_reader_Surfcae_1);
